...
module sim_qspi_pmod #(
    ...
    parameter   ROM_BITS       = 15, // 32 KB ROM
    parameter   RAM_A_BITS     = 13, // 8 KB RAM
    parameter   RAM_B_BITS     = 12, // 4 KB RAM
    parameter   PROG_HEX       = "rv2a03_test.hex"
) (
    ...
    BRAM #(.ADDR_WIDTH(ROM_BITS), .INIT_FILE(PROG_HEX)) rom (
        .clk(qspi_clk),
